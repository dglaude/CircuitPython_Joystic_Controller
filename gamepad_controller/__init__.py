...
HID Radial Controller device helper library transformed in Gamepad Controller library
...
class GamepadController:
    ...
    def __init__(self, devices):
        """Create a GamepadController object that will send Gamepad Controller HID reports.
