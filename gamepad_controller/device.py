...
"""
`gamepad_controller.device`
================================================================================

* Author(s): Dan Halbert and David Glaude

The gamepad controller report descriptor used is documented where ???
"""
# pylint: enable=line-too-long

__version__ = "0.0.0-auto.0"
__repo__ = "https://github.com/dglaude/CircuitPython_Joystick_Controller.git"

import usb_hid


def device(report_id):
    """Create a `usb_hid.Device` for a gamepad controller.
